...
client = boto3.client('s3', 
    ...
    aws_access_key_id='ImmNIRfHonWeCluC',
    aws_secret_access_key='M6M1Uk9Ppxq0obuH3InFvqLIwlTbmoTW',
...
try:
    ...
    if e.response['Error']['Code'] == "NoSuchKey":
        # Se Key não existir.
        status_df = pd.read_csv("/home/awari/app/aula-07/ingest/diferencial/usuarios.csv")
